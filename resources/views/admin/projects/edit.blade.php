        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.project.update', $project) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    @if ($project->photo)
                        <img src="{{ public_asset($project->photo) }}" class="img-thumbnail mt-2" width="150">
                    @endif
                </div>

                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" name="is_active" {{ old('is_active', $project->is_active) ? 'checked' : '' }}>
